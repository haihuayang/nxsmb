...
struct netr_UasInfo {
	...
	std::shared_ptr<std::u16string> account_name;/* [string, charset(UTF16)] */
	uint32 priv;
	uint32 auth_flags;
	uint32 logon_count;
	uint32 bad_pw_count;
	...
	std::shared_ptr<std::u16string> computer;/* [string, charset(UTF16)] */
	std::shared_ptr<std::u16string> domain;/* [string, charset(UTF16)] */
	std::shared_ptr<std::u16string> script_path;/* [string, charset(UTF16)] */
	uint32 unknown;
} ;
...
struct netr_ChallengeResponse {
	...
	// x_ndr_unique_with_size_length_TODO<uint8, uint16> data;/* [length_is(length), size_is(size)] */
...
struct netr_GenericInfo {
	...
	std::shared_ptr<std::vector<uint8>> data;/* [size_is(length)] */
	// x_ndr_unique_array_t<uint8, uint32> data;/* [size_is(length)] */
} /* [flag(LIBNDR_PRINT_ARRAY_HEX)] */;
...
struct netr_SamInfo3 {
	...
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	netr_SamBaseInfo base;
	std::shared_ptr<std::vector<netr_SidAttr>> sids; // x_ndr_unique_array_t<netr_SidAttr, uint32> sids;/* [size_is(sidcount)] */
} /* [public] */;
...
struct netr_SamInfo6 {
	...
	netr_SamBaseInfo base;
	std::shared_ptr<std::vector<netr_SidAttr>> sids; // x_ndr_unique_array_t<netr_SidAttr, uint32> sids;/* [size_is(sidcount)] */
	// x_ndr_unique_array_t<netr_SidAttr, uint32> sids;/* [size_is(sidcount)] */
...
struct netr_PacInfo {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<uint8> pac;/* [size_is(pac_size)] */
	lsa_String logon_domain;
	lsa_String logon_server;
	lsa_String principal_name;
	shared_vector<uint8> auth;/* [size_is(auth_size)] */
...
struct netr_USER_PRIVATE_INFO {
	...
	shared_vector<uint8> SensitiveData;/* [flag(LIBNDR_PRINT_ARRAY_HEX), size_is(DataLength)] */
} ;
...
struct netr_DELTA_GROUP_MEMBER {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<uint32> rids;/* [size_is(num_rids)] */
	shared_vector<uint32> attribs;/* [size_is(num_rids)] */
	uint32 unknown1;
	uint32 unknown2;
	uint32 unknown3;
	uint32 unknown4;
...
struct netr_DELTA_POLICY {
	...
	uint8 auditingmode;
	shared_vector<uint32> eventauditoptions;
...
struct netr_DELTA_TRUSTED_DOMAIN {
	...
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	lsa_String domain_name;
	shared_vector<lsa_String> controller_names;/* [size_is(num_controllers)] */
	uint32 SecurityInformation;
	sec_desc_buf sdbuf;
	lsa_String unknown1;
	lsa_String unknown2;
...
struct netr_DELTA_ACCOUNT {
	...
	shared_vector<uint32> privilege_attrib;/* [size_is(privilege_entries)] */
	shared_vector<lsa_String> privilege_name;/* [size_is(privilege_entries)] */
...
struct netr_CIPHER_VALUE {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<uint8> cipher_data;/* [length_is(len), size_is(maxlen)] */
} ;
...
union netr_DELTA_ID_UNION
{
	...
	std::shared_ptr<std::u16string> name;/* [charset(UTF16), string, case(NETR_DELTA_SECRET)] */
} /* [switch_type(netr_DeltaEnum)] */;
...
struct netr_DELTA_ENUM_ARRAY {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<netr_DELTA_ENUM> delta_enum;/* [size_is(num_deltas)] */
} ;
...
struct netr_NETLOGON_INFO_2 {
	...
	netr_InfoFlags flags;
	WERROR pdc_connection_status;
	std::shared_ptr<std::u16string> trusted_dc_name;/* [string, charset(UTF16)] */
...
struct netr_NETLOGON_INFO_4 {
	...
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	std::shared_ptr<std::u16string> trusted_dc_name;/* [string, charset(UTF16)] */
	std::shared_ptr<std::u16string> trusted_domain_name;/* [string, charset(UTF16)] */
} ;
...
union netr_CONTROL_DATA_INFORMATION
{
	...
	void __uninit(x_ndr_switch_t __level);
	std::shared_ptr<std::u16string> domain;/* [charset(UTF16), string, case(NETLOGON_CONTROL_REDISCOVER)] */
	std::shared_ptr<std::u16string> user;/* [charset(UTF16), string, case(NETLOGON_CONTROL_FIND_USER)] */
...
struct netr_DsRGetDCNameInfo {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	std::shared_ptr<std::u16string> dc_unc;/* [string, charset(UTF16)] */
	std::shared_ptr<std::u16string> dc_address;/* [string, charset(UTF16)] */
	netr_DsRGetDCNameInfo_AddressType dc_address_type;
	GUID domain_guid;
	std::shared_ptr<std::u16string> domain_name;/* [string, charset(UTF16)] */
	std::shared_ptr<std::u16string> forest_name;/* [string, charset(UTF16)] */
	netr_DsR_DcFlags dc_flags;
	std::shared_ptr<std::u16string> dc_site_name;/* [string, charset(UTF16)] */
	std::shared_ptr<std::u16string> client_site_name;/* [string, charset(UTF16)] */
} /* [public] */;
...
struct netr_LsaPolicyInformation {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<uint8> policy;/* [size_is(policy_size)] */
} ;
...
struct netr_DomainInformation {
	...
	shared_vector<netr_OneDomainInfo> trusted_domains;/* [size_is(trusted_domain_count)] */
...
struct netr_DsRAddressToSitenamesWCtr {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<lsa_String> sitename;/* [size_is(count)] */
} ;
...
struct netr_DsRAddress {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<uint8> buffer;/* [size_is(size)] */
} ;
...
struct netr_DomainTrust {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	std::shared_ptr<std::u16string> netbios_name;/* [string, charset(UTF16)] */
	std::shared_ptr<std::u16string> dns_name;/* [string, charset(UTF16)] */
...
struct netr_DomainTrustList {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<netr_DomainTrust> array;/* [size_is(count)] */
} ;
...
struct netr_DsRAddressToSitenamesExWCtr {
	...
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<lsa_String> sitename;/* [size_is(count)] */
	shared_vector<lsa_String> subnetname;/* [size_is(count)] */
} ;
...
struct DcSitesCtr {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<lsa_String> sites;/* [unique, size_is(num_sites)] */
} ;
...
struct netr_TrustInfo {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<uint32> data;/* [size_is(count)] */
	uint32 entry_count;
	shared_vector<lsa_String> entries;/* [size_is(count)] */
} ;
...
struct NL_DNS_NAME_INFO {
	...
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	netr_DnsType type;
	std::shared_ptr<std::u16string> dns_domain_info;/* [string, charset(UTF16)] */
...
struct NL_DNS_NAME_INFO_ARRAY {
	...
	x_ndr_off_t ndr_buffers(x_ndr_pull_t &__ndr, x_ndr_off_t __bpos, x_ndr_off_t __epos, uint32_t __flags, x_ndr_switch_t __level);
	void ostr(x_ndr_ostr_t &__ndr, uint32_t __flags, x_ndr_switch_t __level) const;
	shared_vector<NL_DNS_NAME_INFO> names;/* [size_is(count)] */
} /* [public] */;
