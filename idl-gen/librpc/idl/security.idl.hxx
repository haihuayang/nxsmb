...
template <> struct x_ndr_traits_t<dom_sid> {
	using has_buffers = std::false_type;
...
{
	X_ASSERT(__level == X_NDR_SWITCH_NONE);
	return x_ndr_push_uint64(__val, __ndr, __bpos, __epos, __flags);
}
...
struct security_descriptor {
	...
	std::shared_ptr<dom_sid> owner_sid;/* [relative] */
	std::shared_ptr<dom_sid> group_sid;/* [relative] */
	std::shared_ptr<security_acl> sacl;/* [relative] */
	std::shared_ptr<security_acl> dacl;/* [relative] */
...
struct sec_desc_buf {
	...
	// x_ndr_unique_ptr_t<security_descriptor, uint32> sd;
} /* [public] */;
