...
struct dcerpc_ctx_list {
	...
	x_ndr_vector_with_count_t<ndr_syntax_id> transfer_syntaxes;
} ;
...
struct dcerpc_bind {
	...
	x_ndr_vector_with_count_t<dcerpc_ctx_list> ctx_list;
...
struct dcerpc_bind_ack {
	...
	uint16 max_recv_frag;
	uint32 assoc_group_id;
	x_ndr_strlz_t<std::string, uint16_t> secondary_address;
	x_ndr_vector_with_count_t<dcerpc_ack_ctx> ctx_list;
	DATA_BLOB auth_info;/* [flag(LIBNDR_FLAG_REMAINING)] */
} ;
