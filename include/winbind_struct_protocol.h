...
#define WINBINDD_PRIV_SOCKET_SUBDIR_PATH "/home/samba/lib/winbindd_privileged" /* path of the 'privileged' pipe */
...
struct winbindd_request {
	...
	uint32_t epoch;	/* second when the request is created */
...
#define WINBINDD_DELAY_WARNING_THRESHOLD	60
