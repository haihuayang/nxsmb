		...
		const std::vector<uint8_t> &output)
{
	...
	SIVAL(outhdr, SMB2_HDR_OPCODE, SMB2_OP_READ);
	...
	x_put_be32(outnbt, 0x40 + X_SMB2_READ_RESP_BODY_LEN + output.size());

	msg->out_buf = outbuf;
	msg->out_off = 4;
	msg->out_len = 4 + 0x40 + X_SMB2_READ_RESP_BODY_LEN + output.size();
