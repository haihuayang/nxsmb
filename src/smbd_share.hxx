...
struct x_smbd_share_t
{
	...
	virtual NTSTATUS create(x_smbd_open_t **psmbd_open,
...
std::shared_ptr<x_smbd_share_t> x_smbd_dfs_namespace_create(const std::string &name, const std::string &dfs_root);
